...
#### Step 7. (Optional) Install Laravel Passport for Rest Api or Sanctum - Recommended (https://github.com/nhrrob/laravelwiki/blob/master/laravel-sanctum-installation.md)
